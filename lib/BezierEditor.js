  ...
  function BezierEditor() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BezierEditor.__proto__ || Object.getPrototypeOf(BezierEditor)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (_this.state.down) {
        ...
        value[i + 1] = _this.props.verticalFlip ? 1 - _this.inversey(y) : _this.inversey(y);
  ...
  _createClass(BezierEditor, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          pinchColor = _props.pinchColor,
          pinchWidth = _props.pinchWidth,
      ...
      var multiplierIn = this.props.pinchIn ? 1 - this.props.pinchIntensity : 1;
      var multiplierOut = this.props.pinchOut ? 1 - this.props.pinchIntensity : 1;
      var pinchValue = [].concat(this.props.value);
      var intensityChange = -0.1 * this.props.pinchIntensity;
...
BezierEditor.propTypes = {
  ...
  verticalFlip: _propTypes2.default.bool,
  ...
  pinchIn: _propTypes2.default.bool,
  pinchOut: _propTypes2.default.bool,
  pinchIntensity: _propTypes2.default.number,
  pinchColor: _propTypes2.default.string,
  pinchWidth: _propTypes2.default.number
};
